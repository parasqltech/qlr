                      ...
                      <div className="footer-data social-li-pad">
                        ...
                        {/*  */}
                          ...
                          <ListGroup as="ul" horizontal className="social-icons align-items-center">
                            <ListGroup.Item as="li" className="font-16 font-regular">
                            <Link className="nav-link p-0" target="_blank" to="https://www.linkedin.com/company/qlresources/">
                                <FaLinkedinIn/>
                            </Link>
                            </ListGroup.Item>
                            <ListGroup.Item as="li" className="font-16 font-regular">
                ...
                <Container>
                  <Row className="align-items-center justify-content-between">
                    <Col xl={6} lg={6} md={6} className="text-left">
                      <p className="font-16 font-regular text-white mb-0">© 2023 <Link to="/" className="text-white">QLResources</Link> All rights reserved.</p>
                    </Col>
